...
public class mergesort_std extends AppCompatActivity {
    Toolbar myToolbar2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myToolbar2.setTitle(R.string.mergeSort);// toolbar layout file
        ...
        String url = "file:///android_asset/mergesort.html";
        webview.loadUrl(url);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.studdy)
        {
            Intent i = new Intent(this, selectionSort.class);
            startActivity(i);
        }
        return true;
    }
